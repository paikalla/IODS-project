...
library(GGally)
library(ggplot2)
learning2014 <- read.csv("./data/learning2014.csv", stringsAsFactors = TRUE)
str(learning2014)
```
...
```{r}
fit1 <- lm(points ~ attitude + stra + surf, data = learning2014)
summary(fit1)
```
